...
public class DatabaseDataWorker
{
	...
	private void insertCourse(String courseId, String title)
	{
		...
		values.put(NotesForLaterDatabaseContract.CourseInfoEntry.COLUMN_COURSE_ID, courseId);
		values.put(NotesForLaterDatabaseContract.CourseInfoEntry.COLUMN_COURSE_TITLE, title);

		long newRowId = mDb
				.insert(NotesForLaterDatabaseContract.CourseInfoEntry.TABLE_NAME, null, values);
	}
	...
	{
		ContentValues values = new ContentValues();
		values.put(NotesForLaterDatabaseContract.NoteInfoEntry.COLUMN_COURSE_ID, courseId);
		values.put(NotesForLaterDatabaseContract.NoteInfoEntry.COLUMN_NOTE_TITLE, title);
		values.put(NotesForLaterDatabaseContract.NoteInfoEntry.COLUMN_NOTE_TEXT, text);

		long newRowId = mDb
				.insert(NotesForLaterDatabaseContract.NoteInfoEntry.TABLE_NAME, null, values);
	}
